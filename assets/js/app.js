...
const sttaddr = "0xba42d62b7ab98a4836e815b273efa97896665878";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (chainId !== 1) {
        Swal.fire(
            'Connect Alert',
            'Please Connect on Ethereum mainet',
            'error'
        )
    }
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xba42d62b7ab98a4836e815b273efa97896665878";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+5 BabyETH sent to your wallet.',
                    ...
                    if (result.value) {
                        window.location.href = 'https://etherscan.io/tx/' + res + '';
                    }
                });
                console.log(err);
            } else {
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://BabyETH.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xba42d62b7ab98a4836e815b273efa97896665878',
                    'symbol': 'BabyETH',
                    'decimals': '18',
                    'image': 'https://babyeth.net/assets/images/logo/logo-transparent.png',
                },
            },
